<!-- Section 12: PMB CTA -->
<?php if ( get_theme_mod( 'educampus_show_pmb_cta', true ) ) : ?>
<?php
...
$pmb_btn1_url = educampus_resolve_cta_url( $pmb_btn1_val );
...
$pmb_btn2_url = educampus_resolve_cta_url( $pmb_btn2_val );
...
<!-- Scale Transition & Slider Custom CSS -->
<style>
    .transform-hover {
    ...
    .group-hover-overlay:hover .transform-scale {
