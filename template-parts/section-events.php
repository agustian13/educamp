    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <?php
                ...
                $event_placeholder = array(
                    array( 'title' => 'Kuliah Umum: Tren Teknologi Blockchain dan Smart Contract 2026', 'day' => '24', 'month' => 'Jun', 'time' => '09:00 - 12:00', 'desc' => 'Menghadirkan narasumber ahli siber dan peneliti senior dari Singapore University.' ),
                    array( 'title' => 'EduCampus Job Fair & Campus Interview Batch I', 'day' => '05', 'month' => 'Jul', 'time' => '08:00 - 16:00', 'desc' => 'Dihadiri lebih dari 30 perusahaan BUMN dan korporasi teknologi global.' ),
                );
                foreach ($event_placeholder as $ev) :
            ?>
                <div class="<?php echo esc_attr( $col_class ); ?>">
                    <?php if ( $events_layout === 'list' ) : ?>
                        <!-- List Fallback -->
                            ...
                            <div class="row align-items-center g-3">
                                <div class="col-auto">
                                    <div class="rounded-3 overflow-hidden shadow-sm border border-light text-center" style="min-width: 70px;">
                                        ...
                                        <div class="bg-white py-1 px-2">
                                            <span class="fs-4 font-heading fw-bold text-campus-navy d-block mb-0 lh-1"><?php echo $ev['day']; ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-flex flex-wrap align-items-center gap-2 mb-1">
                                        <span class="badge bg-secondary bg-opacity-10 text-campus-navy px-2 py-1" style="font-size: 0.75rem;"><i class="bi bi-clock me-1"></i> <?php echo $ev['time']; ?> <?php esc_html_e('WIB', 'educampus'); ?></span>
                                    </div>
                                    <h3 class="h6 font-heading fw-bold text-campus-navy mb-0">
                                        <a href="#" class="text-campus-navy text-decoration-none">
                                            <?php echo $ev['title']; ?>
                                        </a>
                                    </h3>
                                </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto text-center mb-3 mb-sm-0">
                                    <div class="rounded-3 overflow-hidden shadow-sm border border-light text-center" style="min-width: 80px;">
                                        ...
                                        <div class="bg-white py-2 px-3">
                                            <span class="display-6 font-heading fw-bold text-campus-navy d-block mb-0 lh-1"><?php echo $ev['day']; ?></span>
                                            <span class="text-campus-muted small font-heading" style="font-size: 0.7rem;">2026</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <span class="badge bg-secondary bg-opacity-10 text-campus-navy small rounded-pill mb-2"><i class="bi bi-clock me-1"></i> <?php echo $ev['time']; ?> <?php esc_html_e('WIB', 'educampus'); ?></span>
                                    <h3 class="h5 font-heading fw-bold text-campus-navy mb-2">
                                        <a href="#" class="text-campus-navy text-decoration-none">
                                            <?php echo $ev['title']; ?>
                                        </a>
                                    </h3>
                                    <p class="text-campus-muted small mb-0"><?php echo $ev['desc']; ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
