<?php
/**
 * The template for displaying program taxonomy archives (e.g. program levels like S1)
 *
 * @package EduCampus
 */
...
$level_filter   = isset( $_GET['prog_level'] ) ? sanitize_text_field( $_GET['prog_level'] ) : $current_term_slug;
...
<div class="container my-5 pb-5">
    ...
    <div class="row g-4 mt-2">
        ...
        <aside class="col-lg-3">
            <div class="card border-0 shadow-campus-soft rounded-campus p-4 bg-white sticky-lg-top" style="top: 100px; z-index: 10;">
                ...
                <form method="get" action="">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <?php if ( ! empty( $keyword_filter ) || ! empty( $faculty_filter ) || $level_filter !== $current_term_slug ) : ?>
                            <a href="<?php echo esc_url( get_term_link( $current_term ) ); ?>" class="btn btn-campus-outline btn-sm py-2 text-center text-decoration-none">
